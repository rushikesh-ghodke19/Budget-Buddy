                ...
                >
                  ...
                  <td className="px-6 py-4 text-center">
                    <div className="flex justify-center gap-2">
                      <button className="px-3 py-1 text-budget-buddy-700 text-base bg-budget-buddy-100 hover:bg-budget-buddy-200 rounded-lg">
                        Edit
                      </button>
                      <button className="px-3 py-1 text-base bg-red-100 text-red-600 hover:bg-red-200 rounded-lg">
                        Delete
                      </button>
                    </div>
                  </td>
