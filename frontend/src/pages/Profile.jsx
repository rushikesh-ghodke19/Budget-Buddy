...
const Profile = () => {
  ...
  const avgDailyExpense = thisMonthExpenses
    ? Math.round(thisMonthExpenses / todayDate)
    : 0;
    ...
    <>
      <div className="w-full h-full flex flex-col min-h-0 overflow-hidden">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
          <div className="w-full pb-4 border-b border-b-gray-200">
            <h1 className="text-[1.4rem] sm:text-3xl font-semibold text-gray-800">
        ...
        <div className="flex flex-col gap-12 flex-1 min-h-0">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 mt-6">
            ...
            <KPICard title="Daily Avg Expense" value={avgDailyExpense} loading={loading} />
          </div>

          <div className="flex flex-col gap-8 flex-1 min-h-0">
            {/* Title */}
            <h2 className="text-2xl font-semibold text-gray-800 border-b pb-4 border-b-gray-200">
              Recent Expenses
            </h2>

            {/* Table Container */}
            <div className="flex-1 min-h-0">
              <div className="w-full h-full bg-white rounded-xl border border-gray-200 shadow-[0_10px_30px_rgba(0,0,0,0.08)] flex flex-col overflow-hidden">
                {loading ? (
